...
public class Storage {
    ...
    public String removeAmount(int productId, float removeAmount) throws NullPointerException  {
        Product p = getProductById(productId);
        products.get(products.indexOf(p)).setAmount(p.getAmount() - removeAmount);
        return "Ok";
    }

    public String addAmount(int productId, float addAmount) throws NullPointerException  {
        Product p = getProductById(productId);
